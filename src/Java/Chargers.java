...
public class Chargers extends MouseAdapter implements ActionListener {
	JFrame frame;
	public JTable t1;
	JButton b1, b2, b3, b4;
	JTextField tf1;
	...
	static Jdbc connection_string = new Jdbc();
	 static String table= "chargers_stock";

	Chargers() {

		frame = new JFrame(" chargers STOCK ");
		...
		try {
			...
			ResultSet rs2 = connection_string.retrive(q);
			while (rs2.next()) {
