...
public class Mobile extends MouseAdapter implements ActionListener {
	JFrame frame;
	public JTable t1;
	JButton b1, b2, b3, b4;
	JTextField tf1;
	...
	private static String table = "mobile_stock";

	Mobile() {

		frame = new JFrame(" MOBILE STOCK ");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == b2) {
			...
			JOptionPane.showMessageDialog(null, "FOR UPDATE SELECT ONE ROW FROM TABLE");
		}
